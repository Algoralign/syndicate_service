...
export class Initial1742031047474 implements MigrationInterface {
    name = 'Initial1742031047474'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "payment_receipts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "recipt_img" character varying, "approved" boolean NOT NULL DEFAULT false, "rejected" boolean NOT NULL DEFAULT false, "investment_amount" numeric(15,2) NOT NULL DEFAULT '0', "reject_reason" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, "dealId" uuid, "syndicateId" uuid, "systemReceivingAccountId" uuid, CONSTRAINT "PK_42242bb7e01c7d075b35bd13fe0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "syndicates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "ticket_size" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "investmentInstrumentId" uuid, CONSTRAINT "PK_82297fa598f01e7de64bef4cf45" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "invitation_trackers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "first_name" character varying, "last_name" character varying, "email" character varying, "proposed_amount" numeric(15,2) NOT NULL DEFAULT '0', "allocation_size" numeric(15,2) NOT NULL DEFAULT '0', "currency" "public"."invitation_trackers_currency_enum" NOT NULL DEFAULT 'USD', "email_sent" boolean NOT NULL DEFAULT false, "user_type" character varying, "logged_in" boolean NOT NULL DEFAULT false, "user_invested_in_deal" boolean NOT NULL DEFAULT false, "user_accepted_invite" boolean NOT NULL DEFAULT false, "invite_type" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "invitedById" uuid, "dealId" uuid, "syndicateId" uuid, "payment_receipt_id" uuid, CONSTRAINT "REL_27d1cbfa412e3d1d73089fad3c" UNIQUE ("payment_receipt_id"), CONSTRAINT "PK_5f520e6ceb6a46c2c5111165872" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "addresses" ADD CONSTRAINT "FK_98e1ca336038167c7eb48c02582" FOREIGN KEY ("country_id") REFERENCES "countries"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "kycs" ADD CONSTRAINT "FK_bbfe1fa864841e82cff1be09e8b" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
