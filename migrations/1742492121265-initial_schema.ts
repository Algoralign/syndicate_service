...
export class InitialSchema1742492121265 implements MigrationInterface {
    name = 'InitialSchema1742492121265'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "investments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "investment_fee" numeric(15,2) NOT NULL DEFAULT '0', "investment_amount" numeric(15,2) NOT NULL DEFAULT '0', "proposed_amount" numeric(15,2) NOT NULL DEFAULT '0', "actual_disbursed_amount" numeric(15,2), "disbursement_date" date, "investment_status" "public"."investments_investment_status_enum" NOT NULL DEFAULT 'PENDING', "currency" "public"."investments_currency_enum" NOT NULL DEFAULT 'USD', "remarks" text, "is_active" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid NOT NULL, "dealId" uuid NOT NULL, "syndicateId" uuid NOT NULL, "paymentReceiptId" uuid, CONSTRAINT "REL_40871c61472ef06b6aa4b612d1" UNIQUE ("paymentReceiptId"), CONSTRAINT "PK_a1263853f1a4fb8b849c1c9aff4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "invitation_trackers" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "first_name" character varying, "last_name" character varying, "email" character varying, "proposed_amount" numeric(15,2) NOT NULL DEFAULT '0', "investment_fee_on_proposed_amount" numeric(15,2) NOT NULL DEFAULT '0', "proposed_amount_plus_investment_fee" numeric(15,2) NOT NULL DEFAULT '0', "actual_amount_invested" numeric(15,2) NOT NULL DEFAULT '0', "investment_fee_on_actual_amount_invested" numeric(15,2) NOT NULL DEFAULT '0', "allocation_size" numeric(15,2) NOT NULL DEFAULT '0', "currency" "public"."invitation_trackers_currency_enum" NOT NULL DEFAULT 'USD', "email_sent" boolean NOT NULL DEFAULT false, "user_type" character varying, "logged_in" boolean NOT NULL DEFAULT false, "receipt_uploaded" boolean NOT NULL DEFAULT false, "user_invested_in_deal" boolean NOT NULL DEFAULT false, "user_accepted_invite" boolean NOT NULL DEFAULT false, "invite_type" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "invitedById" uuid, "dealId" uuid, "syndicateId" uuid, "payment_receipt_id" uuid, "user_id" uuid, CONSTRAINT "REL_27d1cbfa412e3d1d73089fad3c" UNIQUE ("payment_receipt_id"), CONSTRAINT "PK_5f520e6ceb6a46c2c5111165872" PRIMARY KEY ("id"))`);
